...
lib.dropdown.kuenstler {
	wrap = <div class="artist_select hidden-sm hidden-xs"><form action="GET"><select class="form-control" onchange="window.location=this.options[this.selectedIndex].value"><option value="">--Supports--</option>|</select></form></div>
	10 = CONTENT
	10 {
